 ...
 * be written outside `uploads`) and unit-tests the `sanitizeUploadFilename` helper.
 */
...
import { sanitizeUploadFilename, chatIntegrationManager } from './chat-integration-manager'
...
describe('SUP-231 sanitizeUploadFilename', () => {
